...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your one-time sign-in link for SCORZ</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Sign in to SCORZ</Heading>
        <Text style={text}>
          Tap the button below to sign in — no password needed. This link expires shortly.
        </Text>
